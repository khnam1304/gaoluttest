...
(function (window) {
    ...
    function lignePaginate() {
        ...
        _lignePaginate.filter = function () {
            ...
            const filter = document.querySelector(filterSettings.el) == null ? "" : document.querySelector(filterSettings.el).value.toUpperCase();
