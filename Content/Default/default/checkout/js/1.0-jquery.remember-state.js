  ...
  var remember_state = {
    ...
    _defaultNoticeDialog: function() {
      return $("<p />", { "class": "remember_state" })
            .html('Do you want to restore your previously entered info <a href="#">Yes </a>?' + '<span style="cursor: pointer;margin-left: 9px; background: #ccc;padding: 0px 15px;color: #717171;">No, latter.</span>');
    },
    noticeDialog: null,
