$(function () {
    ...
    var MARKER_ICON_DEFAULT = '/assets/images/vendor/icon-marker.png';
    var sort = {
        ascent: function (key) {
            return function (a, b) {
                var ax = ko.toJS(a),
    ...
    function Master() {
        ...
        self.click_list = function (data, event) {
            ...
            if (pre_selected) {
                pre_selected.marker.setIcon(MARKER_ICON_DEFAULT);
            }
            if (pre_selected != data) {
                data.marker.setIcon(MARKER_ICON_DEFAULT);
